...
# Stages of Change Assessment
    ...
    """)
    stage = st.radio("Which of the following best describes your current stage of behavior change?", ("Precontemplation", "Contemplation", "Preparation", "Action", "Maintenance"))
...
# Barriers to Physical Activity
    ...
    st.write("Understanding barriers can help us address obstacles to engaging in regular physical activity.")
...
# Results Page
    ...
    if 'confidence' in st.session_state and st.session_state.confidence is not None:
        st.write(f"**Self-Efficacy Score**: {st.session_state.confidence}")
    else:
        st.write("Please complete the Self-Efficacy assessment first.")
    
    if 'stage' in st.session_state and st.session_state.stage:
